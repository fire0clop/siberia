...
## [x] Блок 3 — Push-уведомления (закрыт 2026-09-08: friend/group/VoIP пуши, FCM v1, APNs-хедеры; живой тест на устройстве — за пользователем)
...
## [x] Блок 4 — Тесты бэкенда + рабочий CI (закрыт 2026-09-07: pytest-инфраструктура, 76 тестов, CI-джоба)
...
## [x] Блок 5 — Тесты iOS (закрыт 2026-09-08: тест-таргет создан, 27 тестов, macOS-джоба в CI)
...
## [~] Блок 6 — Звонки 1-на-1 (код готов: TURN через /calls/ice-servers, таймауты ringing, CallKit-фиксы; остаётся деплой coturn и живой тест на устройствах)
...
## [~] Блок 7 — Sprint 4: фичи (2026-09-08: сделаны entities/markdown, архив+папки, link preview, stories, E2E secret chats v1; стикеры/GIF отложены решением пользователя)
...
## [~] Блок 8 — Полировка и долг (2026-09-08: локализация-инфраструктура (ru→en, 66 строк), a11y-подписи, iPad/UIScreen-фиксы; Redis-based rate limiter — остаётся)
