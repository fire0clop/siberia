...
> **⚠️ Исторический снапшот (июль 2026).** Актуальное состояние — в README.md,
> ROADMAP.md и в тестах (`backend/Siberia/tests`, 76 шт.; `frontend/SiberiaTests`, 27 шт.).
> С тех пор добавлены: text entities, архив+папки, link preview, stories,
> E2E secret chats, инвайт-ссылки каналов, модерация, TURN/ICE-эндпоинт,
> FCM v1, пуши на заявки/группы — см. git log.
